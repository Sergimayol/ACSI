...
for i in $(seq 1 10); do
    ...
    time sysbench cpu --cpu-max-prime=50000 --time=0 --threads=6 --max-requests=50000 run >>sysbench25k.txt
done
read res
echo "---------------------------------"
...
for i in $(seq 1 10); do
    ...
    time sysbench cpu --cpu-max-prime=100000 --time=0 --threads=6 --max-requests=100000 run >>sysbench25k.txt
done
read res
echo "---------------------------------"
...
for i in $(seq 1 10); do
    ...
    time sysbench cpu --cpu-max-prime=150000 --time=0 --threads=6 --max-requests=150000 run >>sysbench25k.txt
done
echo "---------------------------------"
